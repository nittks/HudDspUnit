...
//	CLKCTRL.MCLKCTRLB	= CLKCTRL_PDIV_8X_gc | CLKCTRL_PEN_bm;
	...
	PORTD.PIN0CTRL	= (1<<PORT_PULLUPEN_bp | PORT_ISC_RISING_gc );	// ロータリーエンコーダA
	PORTD.PIN1CTRL	= (1<<PORT_PULLUPEN_bp | PORT_ISC_RISING_gc );	// ロータリーエンコーダC
	PORTD.PIN2CTRL	= (1<<PORT_PULLUPEN_bp);	// push sw
